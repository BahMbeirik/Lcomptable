            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-lg shadow p-5 border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-800 font-semibold">{entry.debit_account}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Montant</label>
                    <p className="text-2xl font-bold text-green-600">{formatCurrency(entry.debit_amount)}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-5 border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-sm font-medium text-gray-500">Compte</label>
                    <p className="text-gray-800 font-semibold">{entry.credit_account}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Montant</label>
                    <p className="text-2xl font-bold text-red-600">{formatCurrency(entry.credit_amount)}</p>
                  </div>
                </div>
              </div>
            </div>
